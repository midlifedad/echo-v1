/**
 * Contract Test: POST /api/data-import/upload
 * Tests CSV file upload endpoint
 */

import { describe, it, expect, beforeAll, afterAll } from '@jest/globals';

describe('POST /api/data-import/upload', () => {
  const endpoint = '/api/data-import/upload';
...
2,Jane Smith,false,2024-02-20,87.3,Standard`;
    ...
    expect(typeMap['Category']).toBe('category');
  });
  ...
  it('should limit preview to 10 rows', async () => {
    ...
    expect(result.preview.totalRows).toBe(20);
  });
});