      ...
      <DropdownMenuTrigger asChild>
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            ...
            <div
              className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-medium text-text-inverse"
            ...
            {showText && (
              <div className="flex flex-col items-start flex-1 min-w-0">
                ...
                <span className="text-xs text-black/70">Client</span>
              </div>
            )}
          </div>

          {showText && (
            <ChevronDown size={16} className="text-black flex-shrink-0" />
          )}
        </Button>
      </DropdownMenuTrigger>
